...
clearBtn.addEventListener('click', function () {
  ...
  function clearLocalStorageAndRefreshPage() {
   localStorage.setItem('text',null)
   localStorage.setItem('images',null)
   
    localStorage.clear('images,text');
    location.reload('images,text');
}
...
localStorage.setItem('tempStorageOject', JSON.stringify(tempStorageObject));
...
/
storedData = JSON.parse(localStorage.getItem('tempStorage'));
