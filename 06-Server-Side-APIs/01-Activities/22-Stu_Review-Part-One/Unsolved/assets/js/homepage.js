...
const buttonClickHandler = function (event) {
  ...
  // TODO: Write your answer here constance  the element  your clicking on
  const language = event.target.getAttribute('data-language');

  // Why is this `if` block in place?
  // TODO: Write your answer here he if block is in place to check if the language attribute exists 
If the language attribute exists, it means that the button clicked has a specific language associated with it, and the code proceeds to call the getFeaturedRepos() function with that language parameter.
  if (language) {
...
const displayRepos = function (repos, searchTerm) {
  ...
  for (let repoObj of repos) {
    ...
    // TODO: Write your answer here line  taking the response and showing it on the screen 
