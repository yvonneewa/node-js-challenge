...
describe('Arithmetic', () => {
  ...
  describe('sum', () => {
    it('should take two numbers and add them together', () => {
      const total = 4;
      const arithmetic = new Arithmetic(2, 2, "sum");
  ...
  describe('difference', () => {
    it('should take two numbers find the difference', () => {
      const total = 0;
      const arithmetic = new Arithmetic(2, 2, "difference");
  ...
  describe('product', () => {
    it('should take two numbers and multiply them together', () => {
      const total = 4;
      const arithmetic = new Arithmetic(2, 2, "product");
  ...
  describe('quotient', () => {
    it('should take two numbers and divide them', () => {
      const total = 1;
      const arithmetic = new Arithmetic(2, 2, "quotient");
  ...
  describe('modulus', () => {
    it('should calculate 2 % 2 and return 0 as the remainder', () => {
      const total = 0;
      const arithmetic = new Arithmetic(2, 2, "modulus");
  ...
  describe('modulus', () => {
    it('should calculate 3 % 2 and return 1 as the remainder', () => {
      const total = 1;
      const arithmetic = new Arithmetic(3, 2, "modulus");
      expect(arithmetic.modulus()).toEqual(total);
    });
  });
  ...
  describe('modulus', () => {
    it('should calculate 10 % 6 and return 4 as the remainder', () => {
      const total = 4;
      const arithmetic = new Arithmetic(10, 6, "modulus");
      expect(arithmetic.modulus()).toEqual(total);
    });
  });
  ...
  describe('Num1 and Num2 are integers', () => {
    it('should throw an error when the Num1 or Num2 arguments are not integers', () => {
      const cb = () => new Arithmetic(1, "1", 'sum');
